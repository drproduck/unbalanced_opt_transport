...
def sinkhorn_uot_newstop(C, r, c, eta=1.0, t1=1.0, t2=1.0, n_iter=100, early_stop=True, eps=None, opt_val=None):
    """
    :arg C: cost matrix
    ...
    for i in range(n_iter):
        ...
        if eps is not None and np.abs(unreg_f_val_list[-2] - unreg_f_val_list[-1]) / unreg_f_val_list[-2] <= eps / opt_val:
            stop_iter = i + 1
            break
